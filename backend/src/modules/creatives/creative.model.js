...
const CreativeSchema = new mongoose_1.Schema({
    tenantId: { type: mongoose_1.default.Schema.Types.ObjectId, ref: 'Tenant', required: true, index: true },
    campaignId: { type: mongoose_1.default.Schema.Types.ObjectId, ref: 'Campaign', required: true, index: true },
