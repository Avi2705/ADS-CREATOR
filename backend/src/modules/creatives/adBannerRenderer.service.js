...
exports.generateAdBannerSVG = generateAdBannerSVG;
exports.renderAndUploadAdBanner = renderAndUploadAdBanner;
 ...
 */
async function generateAdBannerSVG(params) {
 ...
 */
async function renderAndUploadAdBanner(params) {
    const svgDataUri = await generateAdBannerSVG(params);
    try {
        if (process.env.CLOUDINARY_CLOUD_NAME || process.env.CLOUDINARY_URL) {
            const result = await cloudinary_1.v2.uploader.upload(svgDataUri, {
...
//# sourceMappingURL=adBannerRenderer.service.js.map